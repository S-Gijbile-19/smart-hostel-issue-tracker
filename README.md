...
* 🏠 **Hostel Tagging** – Issues are automatically tagged with hostel, block, and room information.
* 🔍 **Lost & Found System** – Report and search for lost or found items.
...
Hostel residents often face difficulties reporting issues or tracking their resolution status. This platform provides a **centralized system** where problems can be reported, monitored, and managed effectively.
...
This project was developed as part of **HackOverflow** organized by **Indian Institute of Technology Goa**.

Project is live at : https://smart-hostel-issue-tracker.streamlit.app
